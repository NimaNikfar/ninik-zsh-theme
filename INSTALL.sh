...
# source : https://github.com/alejandromume/ubunly-zsh-theme/blob/main/INSTALL.sh
...
cp ninik.zsh-theme $zsh_custom_directory/themes
printf "${BOLD_CYAN}\n\n[-] ${NC}Installing Theme...\n\n"
...
printf "\n${Green}[✱] ${ORANGE}NINIK ZSH Theme ${Green}Installed successfully!${NC}\n\n"

printf "╔═════════════════════════════════════════╗ \n"
printf "║ Set ${ORANGE}ninik ${NC}as ZSH_THEME in your .zshrc   ║ \n"
printf "╚═════════════════════════════════════════╝ \n\n"
